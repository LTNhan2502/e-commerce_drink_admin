...
export default function MenuDetailsComponent() {
    ...
    return (
        <>
            ...
            <div className="container mx-auto mt-3 text-end">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="col-span-1 overflow-x-auto rounded-lg shadow-lg">
                        <button
                            className="bg-blue-500 text-white my-3 mx-3 px-4 py-2 rounded-md flex items-center justify-center"
                            ...
                            {size.map((item) => (
                                <tr className="hover:bg-gray-100" key={item._id}>
                                    ...
                                    <td className="px-6 py-4 flex items-center">
                                        <button className="rounded p-2 text-blue-600 hover:text-blue-800">
                                            <LiaEditSolid className="text-2xl" />
                                        </button>
                                        <button className="ml-2 rounded p-2 text-red-600 hover:text-red-800">
